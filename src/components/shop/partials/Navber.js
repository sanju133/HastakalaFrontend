...
const Navber = (props) => {
  ...
  return (
    <Fragment>
      {/* Navber Section */}
      <nav className="fixed top-0 w-full h-13 z-10 shadow-lg lg:shadow-none bg-white">
        <div className="m-3 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
        <div
            onClick={(e) => history.push("/")}
            style={{ letterSpacing: "0.30rem" }}
            className="hidden lg:block flex col-span-1  text-red-900 font-bold tracking-widest uppercase text-2xl cursor-pointer"
          >
            HASTAKALA
          </div>
